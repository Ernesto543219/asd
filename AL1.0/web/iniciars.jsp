<%-- 
    Document   : iniciars
    Created on : 12/10/2016, 07:41:20 PM
    Author     : Alumno
--%>
...
<!-- Barra de navegación -->
    ...
    <center><h1>INICIO DE SESIÓN</h1></center>
            <center>  <form name="Reg" method="post" action="InicioSesion" role="form">
                <div class="form-group">
                    <p class="for">Nickname:<input type="text" name="Nickname"  id="tnic" maxlength="20" required="required" ></p>
                    <p class="for">Contraseña:<input type="password" name="Password"  id="tpas" maxlength="25" required="required" ></p>
                        <p><input type="submit" name="btdes" class ="btn btn-primary" value="Iniciar Sesión"></p><br>

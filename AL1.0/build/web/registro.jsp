<%-- 
    Document   : registro
    Created on : 12/10/2016, 07:16:43 PM
    Author     : Alumno
--%>
...
<!-- Barra de navegación -->
    ...
    <center><h1>REGISTRO</h1></center>
            <center>  <form name="Reg" method="post" action="" role="form">
                <div class="form-group">
                    ...
                    <p class="for">Contraseña:<input type="password" name="tpas"  id="tpas" maxlength="25" required="required" ></p>
                    <p class="for">Verificación de contraseña:<input type="tpas1" name="tpas1"  id="tpas1" maxlength="25" required="required" ></p>
                    <p class="for"> Genero:<br><input type="radio" name="opciones" id="opciones_1" value="opcion_1" checked> Femenino &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="opciones" id="opciones_1" value="opcion_1" checked>
                        <p><input type="submit" name="btdes" class ="btn btn-primary" value="Registrar"></p><br>
